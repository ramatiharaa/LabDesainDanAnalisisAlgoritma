...
* Tiga implementasi menggunakan linier probing, Quadric probing, Double Hashing
...
// Asumsikan kita mengunakan array dengan batas 1024
int storage[1024];
...
int main() {
    ...
    /**
     * Di bawah adalah operasi untuk cetak
     */ 
    cetak(n);
